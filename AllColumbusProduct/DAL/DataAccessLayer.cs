...
namespace AllColumbusProduct.DAL
{
    class DataAccessLayer
    {
        //Server=Admin (Name of Computer) ; /Or Server=192.168.1.99;
        //public static string con = "Server= Admin; Database= AllProducts; Integrated Security=True;";
        public static string con = "Server= 192.168.1.99; Database= AllProducts;User ID=sa ;Password=123;Pooling=false;";
